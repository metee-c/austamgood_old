// API Route: Approve adjustment
// POST: Change status from pending_approval to approved
...
export async function POST(
  ...
  try {
    ...
    // Approve adjustment
    const { data: adjustment, error } = await stockAdjustmentService.approveAdjustment(
      adjustmentId,
      systemUser.user_id
    );
