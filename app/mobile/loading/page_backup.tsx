        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-lg font-bold font-thai">
              {selectedTask ? selectedTask.loadlist_code : 'โหลดสินค้าขึ้นรถ (Loading)'}
            </h1>
          </div>
          <button
            onClick={() => selectedTask ? handleBack() : fetchPendingTasks()}
            disabled={loading}
        ...
        {!selectedTask && (
          <>
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              ...
              <div className="bg-white/15 backdrop-blur-sm rounded-md p-1.5 text-center">
                <div className="text-xl font-bold">{tasks.filter(t => t.status === 'loading' || t.status === 'loaded').length}</div>
            ...
            >
              <span className="flex items-center gap-1.5">
                ...
                <span>กรอง: {
                  ...
                  selectedStatus === 'loading' ? 'กำลังโหลด' :
            ...
            {showFilter && (
              <div className="mt-2 bg-white rounded-lg shadow-lg overflow-hidden">
                {['all', 'pending', 'loading', 'loaded'].map((status) => (
                  <button
                    key={status}
                    onClick={() => {
            ...
            if (filteredTasks.length === 0) {
              return (
                <div className="text-center py-12">
                  ...
                  <p className="text-thai-gray-500 mb-2">
