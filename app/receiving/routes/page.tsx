...
interface SplitItemFormPayload {
    orderItemId: number;
    moveWeightKg: number;
...
// --- Helper Components ย้ายมาไว้ข้างนอก ---
...
const RoutesPage = () => {
    ...
    const VRP_SETTINGS_STORAGE_KEY = 'vrp-settings';
    ...
    const resequenceTripStops = (stops: EditorStop[]) =>
    ...
    // แก้ไข: กำหนด Type สำหรับ variant ของ Badge
