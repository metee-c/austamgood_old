-- Migration: Add order_ids parameter to create_face_sheet_packages function
-- This allows selective face sheet generation for specific orders
-- Date: 2025-11-15

-- Drop existing function
DROP FUNCTION IF EXISTS public.create_face_sheet_packages(character varying, character varying, character varying, date);
