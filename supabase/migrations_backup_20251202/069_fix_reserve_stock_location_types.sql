-- Fix reserve_stock_for_face_sheet_items to use correct location_types
-- The actual location types are 'floor' and 'rack', not 'storage' and 'picking'
...
COMMENT ON FUNCTION reserve_stock_for_face_sheet_items IS 'Reserve stock for face sheet items from floor/rack locations (not preparation areas)';
