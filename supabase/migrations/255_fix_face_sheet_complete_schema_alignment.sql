-- ============================================================================
-- Migration: 255_fix_face_sheet_complete_schema_alignment.sql
-- Description: แก้ไข create_face_sheet_with_reservation ให้ตรงกับ schema ทั้งหมด
-- 
-- Schema Issues Fixed:
-- 1. face_sheets: ใช้ created_date แทน delivery_date
-- 2. face_sheet_items: ใช้ size แทน package_size, ไม่มี hub, customer_id
-- 3. wms_order_items: ใช้ order_qty แทน quantity, ไม่มี uom
-- 4. face_sheet_items: ต้องการ package_id (ใช้ row_number เป็น temp id)
-- ============================================================================
...
BEGIN
    ...
    SELECT 
        pd.face_sheet_id,
        ip.id, -- ✅ Use the actual package ID from inserted_packages
        pd.ref_order_id,
...
'สร้างใบปะหน้าพร้อมจองสต็อคแบบ atomic - ใช้ schema ที่ถูกต้องทั้งหมด (Complete Fix)';
