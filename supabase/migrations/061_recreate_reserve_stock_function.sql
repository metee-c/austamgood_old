-- Migration: Recreate reserve_stock_for_face_sheet_items function after fixing reserved_by type
...
COMMENT ON FUNCTION reserve_stock_for_face_sheet_items(BIGINT, VARCHAR, VARCHAR) IS 
'Reserves stock for face sheet items using FEFO/FIFO logic. Updated to use VARCHAR for reserved_by.';
