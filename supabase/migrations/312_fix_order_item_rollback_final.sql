-- ============================================================================
-- Migration: 312_fix_order_item_rollback_final.sql
-- Description: แก้ไข function ให้ถูกต้องตามโครงสร้างฐานข้อมูลจริง
-- Date: 2026-01-29
-- ============================================================================
...
BEGIN
    ...
    -- Use order_id for entity_id (FK constraint requires order_id, not order_item_id)
    -- ========================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ Migration 312 completed: execute_order_item_rollback function fixed with correct column names';
END $$;
