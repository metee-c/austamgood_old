-- ============================================================================
-- Migration: 311_fix_order_item_rollback_skip_uuid.sql
-- Description: แก้ไข function ให้ใช้ NULL สำหรับ released_by (UUID column)
-- Date: 2026-01-29
-- ============================================================================
...
BEGIN
    ...
    LOOP
        ...
        -- Release reservation (set released_by to NULL since it's UUID type)
...
DO $$
BEGIN
    RAISE NOTICE '✅ Migration 311 completed: execute_order_item_rollback function fixed (skip released_by UUID)';
END $$;
