-- Migration 307: Add missing p_reserved_by_user_id parameter and refresh schema
-- Purpose: แก้ไข schema cache issue - parameter ที่หายไป
-- Date: 2026-02-19
...
'Split balance เมื่อจองสต็อก - ลดทั้ง total และ reserved จาก balance เดิม (Migration 307)';
