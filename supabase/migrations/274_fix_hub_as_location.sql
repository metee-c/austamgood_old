-- ============================================================================
-- Migration: 274_fix_hub_as_location.sql
-- Description: แก้ไขการหา prep_area_location จาก hub โดยใช้ hub โดยตรงจาก face_sheet_packages
--
-- BUG: preparation_area ไม่มี column hub
--      การ JOIN กับ preparation_area ผ่าน hub ไม่ถูกต้อง
--
-- FIX: ใช้ hub จาก face_sheet_packages โดยตรงเป็น source_location_id
--      เพราะ hub คือ location code ที่ต้องการหยิบสินค้าไปส่ง
-- ============================================================================
...
BEGIN
    ...
    FOR v_item IN
        SELECT
            ...
            ms.qty_per_pack,
            -- ✅ FIX: Use hub from face_sheet_packages directly as location
            -- hub is already a location code (e.g., 'PK001', 'PQTD', etc.)
...
'จองสต็อคสำหรับใบปะหน้า - Fix: use hub from face_sheet_packages directly (Migration 274)';
