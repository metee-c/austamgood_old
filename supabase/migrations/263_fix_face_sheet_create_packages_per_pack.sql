-- ============================================================================
-- Migration: 263_fix_face_sheet_create_packages_per_pack.sql
-- Description: แก้ไขการสร้าง Face Sheet ให้สร้าง 1 package ต่อ 1 pack (ไม่ใช่ 1 package ต่อ 1 order_item)
-- 
-- BUG: Face Sheet สร้างแพ็คไม่ครบ
-- - ปัจจุบัน: สร้าง 1 package ต่อ 1 order_item
-- - ที่ถูกต้อง: สร้าง 1 package ต่อ 1 pack (คำนวณจาก order_qty / qty_per_pack)
-- 
-- ตัวอย่าง:
-- - Order Item: 120 ชิ้น, qty_per_pack = 12 → ควรสร้าง 10 packages
-- - ปัจจุบันสร้างแค่ 1 package
-- 
-- แก้ไข:
-- - ใช้ generate_series() เพื่อสร้างหลาย rows ตามจำนวน packs
-- - คำนวณ packs_needed = CEIL(order_qty / qty_per_pack)
-- - สร้าง package_number ที่ unique สำหรับแต่ละ pack
-- ============================================================================
...
'สร้างใบปะหน้าพร้อมจองสต็อคแบบ atomic - สร้าง 1 package ต่อ 1 pack (Fix: Package Count Bug)';
