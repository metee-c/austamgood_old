-- Migration 304: Force refresh split_balance_on_reservation function
-- Purpose: Drop and recreate function to clear Supabase schema cache
-- Date: 2026-02-19

-- ========================================
-- STEP 1: Drop existing function
-- ========================================
DROP FUNCTION IF EXISTS public.split_balance_on_reservation(
  INTEGER, INTEGER, NUMERIC, INTEGER, VARCHAR, INTEGER, VARCHAR, INTEGER
);

DROP FUNCTION IF EXISTS public.split_balance_on_reservation(
  VARCHAR, INTEGER, VARCHAR, NUMERIC, INTEGER, INTEGER, INTEGER
);
...
-- ========================================
-- STEP 2: Recreate function with correct signature
-- ========================================
...
'Split balance เมื่อจองสต็อก - สร้าง balance ใหม่สำหรับยอดที่จอง และบันทึก ledger (Migration 304: Force refresh)';
