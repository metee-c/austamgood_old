...
import { SystemRole, CreateUserData, Employee } from '@/types/user-management-schema';
...
const AddUserForm: React.FC<AddUserFormProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleEmployeeSelect = (employee: Employee) => {
    setFormData(prev => ({
      ...
      full_name: employee.employee_name, // Auto-fill full name
    }));
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-thai-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-thai-gray-900 font-thai">เพิ่มผู้ใช้งานใหม่</h2>
              <p className="text-sm text-thai-gray-600 font-thai">กรอกข้อมูลผู้ใช้งานและกำหนดบทบาท</p>
            </div>
          </div>
          <Button
            variant="ghost"
