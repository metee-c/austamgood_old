...
const ImportFreightRateForm: React.FC<ImportFreightRateFormProps> = ({
  ...
  const handleDownloadTemplate = () => {
    ...
    const csvContent = '\uFEFF' + [
      'เส้นทางขนส่ง,ผู้ให้บริการ,จังหวัดต้นทาง,อำเภอต้นทาง,จังหวัดปลายทาง,อำเภอปลายทาง,ระยะทาง(กม.),ราคาหลัก(บาท),หน่วยราคา,ค่าขั้นต่ำ(บาท),ค่าจุดส่งเพิ่ม(บาท),ค่าเด็กติดรถ(บาท),อัตราค่าน้ำมัน(%),วันที่เริ่มใช้,วันที่สิ้นสุด,หมายเหตุ',
      'กรุงเทพฯ-เชียงใหม่,บริษัท ขนส่งไทย จำกัด,กรุงเทพมหานคร,บางซื่อ,เชียงใหม่,เมืองเชียงใหม่,700.00,21000.00,trip,15000.00,500.00,800.00,5.00,2024-01-01,,เส้นทางภาคเหนือ',
      'สมุทรปราการ-ขอนแก่น,บริษัท ขนส่งรวดเร็ว จำกัด,สมุทรปราการ,เมืองสมุทรปราการ,ขอนแก่น,เมืองขอนแก่น,450.00,1200.00,pallet,2400.00,,,4.50,2024-01-01,,คิดตามจำนวนพาเลท',
      'กรุงเทพฯ-หาดใหญ่,บริษัท ขนส่งปลอดภัย จำกัด,กรุงเทพมหานคร,ห้วยขวาง,สงขลา,หาดใหญ่,950.00,18.00,kg,5000.00,,,5.50,2024-01-01,,คิดตามน้ำหนัก'
    ].join('\n');
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="text-sm text-blue-800 font-thai">
            ...
            <ul className="list-disc list-inside space-y-1 text-blue-700">
              ...
              <li>ข้อมูลที่จำเป็น: เส้นทางขนส่ง, ผู้ให้บริการ, จังหวัดต้นทางและปลายทาง, ระยะทาง, ราคา</li>
              <li>หน่วยราคา: trip (ต่อเที่ยว), kg (ต่อกิโลกรัม), pallet (ต่อพาเลท)</li>
