  ...
  const getTypeInfo = (type: ImportType) => {
    switch (type) {
      ...
      case 'special':
        return {
          title: 'พิเศษ',
          description: 'นำเข้าออเดอร์ประเภทพิเศษ (สินค้าของแถม)',
          columns: 'วันที่, คลัง, เครดิต/เงินสด, เลขที่ใบสั่งส่ง, รหัสลูกค้า/ผู้ขาย, ชื่อร้านค้า, จังหวัด, รหัสสินค้า, ชื่อสินค้า, ฟิลด์เพิ่มเติมประเภทตัวเลข 1, จำนวน, น้ำหนัก, จำนวนแพ็ครวม, แพ็ค 12 ถุง (0.5-1.5 กก.), แพ็ค 4 (4 กก.), แพ็ค 6 (2.5-3 กก.), แพ็ค 1 (7,10,15 กก.), ประเภทข้อความแบบยาว 1, ประเภทข้อความเพิ่มเติม 4, วัน เวลารับสินค้า, หมายเหตุ (เพิ่มเติม), หมายเหตุ (จัดส่ง), เขตการขาย',
          icon: Star,
          color: 'purple'
        };
      default:
