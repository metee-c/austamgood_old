    ...
    <div className={`border-2 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow ${
      ...
      {pricingMode === 'flat' ? (
        <div className="space-y-3 mb-4 bg-gradient-to-br from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-100">
            ...
            <div>
              ...
              <div className="flex gap-1">
                <select
                  ...
                  className="flex-1 px-2.5 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 font-thai bg-white"
                >
                ...
                <button
                  ...
                  className="px-2 py-2 text-sm bg-green-500 text-white rounded hover:bg-green-600 transition-colors"
                  title="เพิ่มผู้ให้บริการขนส่งใหม่"
                >
                  +
                </button>
              </div>
          ...
          {/* Extra Delivery Stops Section - จุดส่งพิเศษที่ไม่มี order (Flat Mode) */}
          <div className="pt-2 border-t border-blue-200">
            <label className="block text-xs font-medium text-gray-700 mb-2 font-thai">
              🎁 จุดส่งพิเศษ (ไม่มี Order) เช่น ถุง ของแถม ของขวัญ
            </label>

            {extraDeliveryStops.map((stop, index) => (
              <div key={index} className="flex gap-2 mb-2 p-2 bg-orange-50 rounded border border-orange-200">
                <input
                  type="text"
                  value={stop.name}
                  onChange={(e) => {
                  ...
                  className="flex-1 px-2.5 py-1.5 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 font-thai bg-white"
                  placeholder="ชื่อจุดส่ง เช่น ร้านค้า ABC"
                />
                <input
                  type="text"
                  ...
                  className="w-32 px-2.5 py-1.5 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 font-thai bg-white"
                ...
                <input
                  ...
                  className="w-24 px-2.5 py-1.5 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 bg-white"
                  placeholder="ราคา"
                  step="1"
                />
                <button
                  type="button"
                  onClick={() => {
                    const newStops = extraDeliveryStops.filter((_, i) => i !== index);
                    setExtraDeliveryStops(newStops);
                  }}
                  className="px-2 py-1.5 text-sm bg-red-500 text-white rounded hover:bg-red-600 transition-colors"
                >
            ...
            <button
              type="button"
              onClick={() => {
                setExtraDeliveryStops([...extraDeliveryStops, { name: '', description: '', cost: 0 }]);
              }}
              className="px-3 py-1.5 bg-orange-500 text-white rounded hover:bg-orange-600 transition-colors font-thai text-xs"
            >
              + เพิ่มจุดส่งพิเศษ
            </button>
          </div>
        ...
        <div className="space-y-3 mb-4 bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-lg border border-green-100">
          ...
          <div>
            ...
            <div className="flex gap-1">
              <select
                value={formData.supplier_id}
                onChange={(e) => handleChange('supplier_id', e.target.value)}
                className="flex-1 px-2.5 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-500 font-thai bg-white"
              >
                <option value="">-- เลือกผู้ให้บริการ --</option>
                {suppliers.map((supplier) => (
                  <option key={supplier.supplier_id} value={supplier.supplier_id}>
          ...
          {/* Extra Delivery Stops Section - จุดส่งพิเศษที่ไม่มี order */}
          <div className="pt-2 border-t border-green-200">
            <label className="block text-xs font-medium text-gray-700 mb-2 font-thai">
              🎁 จุดส่งพิเศษ (ไม่มี Order) เช่น ถุง ของแถม ของขวัญ
            </label>
          ...
          <div className="p-3 bg-white border-2 border-green-300 rounded-lg">
            <div className="text-xs font-thai space-y-1">
              ...
              {extraDeliveryStops.length > 0 && (
                <div className="flex justify-between">
                  <span className="text-gray-600">🎁 จุดส่งพิเศษ ({extraDeliveryStops.length} จุด):</span>
                  <span className="font-medium text-orange-600">{extraDeliveryStops.reduce((sum, stop) => sum + stop.cost, 0).toLocaleString()} ฿</span>
                </div>
              )}
