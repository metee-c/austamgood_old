/**
 * แก้ไขสินค้าที่วางผิดตำแหน่ง 20 รายการที่เหลือ
 * สินค้าเหล่านี้อยู่ที่ PK001 แต่ควรอยู่ที่บ้านหยิบเฉพาะของแต่ละ SKU
 */
...
// รายการสินค้าที่ต้องย้าย (จากหน้า UI)
const ITEMS = [
  { balance_id: 33643, sku_id: 'B-BEY-C|SAL|NS|010', from: 'PK001', to: 'A10-01-004' },
  { balance_id: 33632, sku_id: 'B-BAP-C|IND|010', from: 'PK001', to: 'A10-01-015' },
  { balance_id: 33656, sku_id: 'B-BEY-D|BEF|NS|012', from: 'PK001', to: 'A10-01-012' },
  { balance_id: 33673, sku_id: 'B-BEY-D|SAL|NS|012', from: 'PK001', to: 'A10-01-010' },
  { balance_id: 33645, sku_id: 'B-NET-D|CHI-L|008', from: 'PK001', to: 'A09-01-024' },
  { balance_id: 33666, sku_id: 'B-NET-D|SAL-L|008', from: 'PK001', to: 'A09-01-026' },
  { balance_id: 33665, sku_id: 'B-BEY-D|LAM|NS|012', from: 'PK001', to: 'A10-01-009' },
  { balance_id: 33651, sku_id: 'B-BEY-C|MCK|NS|010', from: 'PK001', to: 'A10-01-007' },
  { balance_id: 33659, sku_id: 'B-BEY-C|MNB|NS|010', from: 'PK001', to: 'A10-01-001' },
  { balance_id: 33628, sku_id: 'B-BEY-C|LAM|NS|010', from: 'PK001', to: 'A10-01-003' },
  { balance_id: 33672, sku_id: 'B-BEY-D|CNL|NS|012', from: 'PK001', to: 'A10-01-011' },
  { balance_id: 33647, sku_id: 'B-BAP-C|HNS|030', from: 'PK001', to: 'A10-01-018' },
  { balance_id: 33664, sku_id: 'B-BEY-D|MNB|NS|010', from: 'PK001', to: 'A10-01-008' },
  ...
  { balance_id: 35926, sku_id: 'B-BAP-C|WEP|010', from: 'PK001', to: 'A10-01-016' },
  { balance_id: 33668, sku_id: 'B-BEY-C|TUN|NS|010', from: 'PK001', to: 'A10-01-006' },
  { balance_id: 35971, sku_id: 'B-NET-D|SAL-S|008', from: 'PK001', to: 'A10-01-026' },
  { balance_id: 33640, sku_id: 'B-BAP-C|IND|030', from: 'PK001', to: 'A10-01-019' }
]

async function main() {
  console.log('🔧 กำลังแก้ไขสินค้าที่วางผิดตำแหน่ง 20 รายการที่เหลือ...\n')
